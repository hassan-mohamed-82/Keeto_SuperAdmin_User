...
exports.variationOptions = (0, mysql_core_2.mysqlTable)("variation_options", {
    ...
    optionName: (0, mysql_core_2.varchar)("option_name", { length: 255 }).notNull(),
    ...
    additionalPrice: (0, mysql_core_2.varchar)("additional_price", { length: 255 }).notNull().default("0"),
    // 👇 الحقل الجديد للتحكم في الاختيار الافتراضي
    isDefault: (0, mysql_core_2.boolean)("is_default").default(false),
    status: (0, mysql_core_2.boolean)("status").default(true),
});
