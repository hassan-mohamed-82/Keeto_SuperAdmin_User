...
router.post("/", (0, middlewares_1.hasPermission)("Restaurants", "Add"), (0, validation_1.validate)(restaurants_2.createRestaurantSchema), (0, catchAsync_1.catchAsync)(restaurants_1.createRestaurant));
...
router.put("/:id", (0, middlewares_1.hasPermission)("Restaurants", "Edit"), (0, validation_1.validate)(restaurants_2.updateRestaurantSchema), (0, catchAsync_1.catchAsync)(restaurants_1.updateRestaurant));
