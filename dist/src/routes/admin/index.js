...
const Keeto_users_1 = __importDefault(require("./Keeto_users"));
const sales_1 = __importDefault(require("./sales"));
const dashboard_1 = __importDefault(require("./dashboard"));
const notification_1 = __importDefault(require("./notification"));
const platform_1 = __importDefault(require("./platform"));
const restaurantGroups_1 = __importDefault(require("./restaurantGroups"));
const orderDelayAlert_1 = __importDefault(require("./orderDelayAlert"));
const restaurantPaymentCredentials_1 = __importDefault(require("./restaurantPaymentCredentials"));
...
router.use("/restaurant-groups", restaurantGroups_1.default);
...
router.use("/keeto-users", Keeto_users_1.default);
router.use("/sales", sales_1.default);
router.use("/dashboard", dashboard_1.default);
router.use("/platform", platform_1.default);
router.use("/restaurant-payment-credentials", restaurantPaymentCredentials_1.default);
