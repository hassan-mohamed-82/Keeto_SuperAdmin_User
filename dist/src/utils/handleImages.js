...
//     try {
//       // الضغط والتحويل صيغة webp بأقصى عرض 1200 والجودة 80%
//       await sharp(buffer)
//         .resize(1200, null, { fit: "inside", withoutEnlargement: true })
//         .webp({ quality: 80 })
//         .toFile(filePath);
//     } catch (sharpErr) {
//       console.warn("⚠️ Sharp processing failed, falling back to raw buffer write:", sharpErr);
//       fileName = `${uuidv4()}.${ext}`;
...
//     const rawImageUrl = `${rawProtocol}://${host}/${relativePath}`;
//     const imageUrl = sanitizeImageUrl(rawImageUrl) || rawImageUrl;
