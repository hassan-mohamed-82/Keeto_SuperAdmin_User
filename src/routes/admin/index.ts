...
import restaurantPaymentCredentialsRouter from "./restaurantPaymentCredentials";
...
router.use("/restaurant-payment-credentials", restaurantPaymentCredentialsRouter);
